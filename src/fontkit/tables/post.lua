...
return r.VersionedStruct.new(r.fixed32, {
  ...
  [2] = {
    ...
    { glyphNameIndex = r.Array.new(r.uint16, 'numberOfGlyphs') },
    { names =          r.Array.new(r.String.new(r.uint8)) }
  },

  [2.5] = {
    { numberOfGlyphs = r.uint16 },
    { offsets =        r.Array.new(r.uint8, 'numberOfGlyphs') }
  },

  [3] = {}, -- version 3 has no additional fields

  [4] = {
    { map = r.Array.new(r.uint32, function(t) return  t.parent.maxp.numGlyphs end) }
  }
})
