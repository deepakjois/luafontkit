...
local OS2 = r.VersionedStruct.new(r.uint16, {
  header = {
    ...
    { fsType =                 r.Bitfield.new(r.uint16, { -- Indicates font embedding licensing rights
      nil, 'noEmbedding', 'viewOnly', 'editable', nil,
      nil, nil, nil, 'noSubsetting', 'bitmapOnly'
    }) },
    ...
    { panose =                 r.Array.new(r.uint8, 10) },   -- describe the visual characteristics of a given typeface
    { ulCharRange =            r.Array.new(r.uint32, 4) },
    { vendorID =               r.String.new(4) },          -- four character identifier for the font vendor
    { fsSelection =            r.Bitfield.new(r.uint16, {  -- bit field containing information about the font
  ...
  [1] = {
    ...
    { winAscent =          r.uint16 },
    { winDescent =         r.uint16 },
    { codePageRange =      r.Array.new(r.uint32, 2) }
  },
...
local versions = OS2.versions
versions[3] = versions[2]
versions[4] = versions[2]
